import { EllipsisVertical, Gift, Heart, MessageCircle } from "lucide-react";
    ...
    <div className="grid gap-4">
      ...
      <div className="flex justify-between items-center">
        <div className="btn flex items-center gap-2">
          <div className="box aspect-square w-10 rounded-lg"></div>
          <div>
            <p className="uppercase">username</p>
            <p className="text-xs">ผู้ติดตาม 0 คน</p>
          </div>
        </div>
        <EllipsisVertical className="btn"/>
      </div>

      <div className="box btn aspect-square rounded-lg"></div>

      <div>
        <p className="text-2xl font-black">ชื่องานศิลปะนี้</p>
      ...
      <div className="flex gap-4">
        ...
        <button className="box btn flex flex-col gap-2 justify-center items-center p-4 flex-1 rounded-lg"><MessageCircle/><p>0</p></button>
